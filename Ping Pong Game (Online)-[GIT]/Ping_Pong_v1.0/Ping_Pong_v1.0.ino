...
#define PIN_BUT_RS		4		// Right start/hit button
#define PIN_BUT_RP		5		// Right power-up button
#define PIN_BUT_LS		6		// Left start/hit button
#define PIN_BUT_LP		7		// Left power-up button
#define PIN_SOUND		8		// Buzzer output (PB1/OC1A)

#define NPIXELS			80		// Number of pixels to handle
